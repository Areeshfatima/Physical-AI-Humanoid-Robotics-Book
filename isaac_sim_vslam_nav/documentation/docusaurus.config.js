...
const config = {
  ...
  tagline: 'A comprehensive guide to NVIDIA Isaac Sim, Isaac ROS VSLAM, and Nav2 path planning for humanoid robots',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/physical-ai-humanoid-robotics/physical-ai-humanoid-robotics/tree/main/isaac_sim_vslam_nav/documentation/',
        },
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Isaac Sim VSLAM Nav',
        logo: {
          alt: 'Isaac Sim VSLAM Nav Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
            ...
            items: [
              {
                ...
                to: '/docs/isaac-sim-integration',
              },
              {
                label: 'Isaac ROS VSLAM',
                to: '/docs/isaac-ros-vslam',
              },
              {
                label: 'Nav2 Path Planning',
                to: '/docs/nav2-path-planning',
              },
            ],
          },
          {
